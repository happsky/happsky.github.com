...
（1）...the最高级+名词+地点（或者of the three 或者 of all）

e1.Helen is the best (good) student of all.
...
e.Taipei is the biggest city in Taiwan.
...
>No后面可以加单数也可以加复数，也可以加不可数名词I have no water to drink.

>比较级的句子当中，any后面的句子习惯用单数，all后面习惯用复数；如果不是比较级的句子，any后面单复数都可以加。

>(注意)加上other（其他的），其功用是为了避免和本身作比较

New York is bigger than **any other city** in America.

New Tork is bigger than **any city** in Taiwan.

## 形容词的原级

as（一样） 原级 as（像） （像...一样）

e1.This jacket is as （一样） expensive as (像) this sweater.

>inexpensive不贵（合理的价格）；cheap便宜的

e2.你的头发和我一样长

Your hair is (头发的状态，长短) as long as mine.

>（注意）否定句时，可用not so（as）...as...（不像什么一样）

e.This question is not as(so) difficult as it seems（似乎，看起来）.

## 副词的比较级和最高级

>He is fast(adj表示状态配表示状态的be动词，物以类聚).

>He runs fast（adv修饰一般动词，一般动词表示动作）.

（1）比较变化

a.规则变化

- 字尾无ly：fast-faster-fastest
...
well(形容词和副词意思不一样，well形容词指身体健康，副词的时候开车开得好，教书教的好)-better-best

much-more-most(many不能当副词)
...
e1.He can sing better(well比较级) than Lisa.

e2.I study harder than my friends.

### the 副词最高级+地点（of...）：the可以省略

e1.My father gets up (the) earliest(adv) of us all.

e2.Cathy dances (the) most beautifully.
...
- Which do you **like(一般动词)** （the） **best/most**, apples, oranges or peaches?
